...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=2.0.39',
    'js/utils.js?v=2.0.39',
    'js/shared.js?v=2.0.39',
    'js/theme.js?v=2.0.39',
    'js/navigation.js?v=2.0.39',
    'js/router.js?v=2.0.39',
    'js/items.js?v=2.0.39',
    'js/scanner.js?v=2.0.39',
    'js/editor.js?v=2.0.39',
    'js/swipe.js?v=2.0.39',
    'js/reorder.js?v=2.0.39',
    'js/app-ui.js?v=2.0.39',
    'js/items-view.js?v=2.0.39',
    'js/items-actions.js?v=2.0.39',
    'js/tabs-view.js?v=2.0.39',
    'js/helpers.js?v=2.0.39',
    'manifest.php?v=2.0.39',
    'icon.php?size=192&theme=hafenblau&v=2.0.39',
    'icon.php?size=512&theme=hafenblau&v=2.0.39',
    'icons/icon.svg',
    'icons/icon-192.png',
    'icons/icon-512.png',
