...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=4.0.5',
    'js/utils.js?v=4.0.5',
    'js/shared.js?v=4.0.5',
    'js/theme.js?v=4.0.5',
    'js/navigation.js?v=4.0.5',
    'js/router.js?v=4.0.5',
    'js/items.js?v=4.0.5',
    'js/scanner.js?v=4.0.5',
    'js/editor.js?v=4.0.5',
    'js/swipe.js?v=4.0.5',
    'js/reorder.js?v=4.0.5',
    'js/app-ui.js?v=4.0.5',
    'js/app-events.js?v=4.0.5',
    'js/app-init.js?v=4.0.5',
    'js/app-runtime.js?v=4.0.5',
    'js/app-entry.js?v=4.0.5',
    'js/items-view.js?v=4.0.5',
    'js/items-actions.js?v=4.0.5',
    'js/tabs-view.js?v=4.0.5',
    'js/helpers.js?v=4.0.5',
    'vendor/zxing/browser-0.1.5.js?v=4.0.5',
    'manifest.php?v=4.0.5',
