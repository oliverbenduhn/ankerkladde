...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=2.0.45',
    'js/utils.js?v=2.0.45',
    'js/shared.js?v=2.0.45',
    'js/theme.js?v=2.0.45',
    'js/navigation.js?v=2.0.45',
    'js/router.js?v=2.0.45',
    'js/items.js?v=2.0.45',
    'js/scanner.js?v=2.0.45',
    'js/editor.js?v=2.0.45',
    'js/swipe.js?v=2.0.45',
    'js/reorder.js?v=2.0.45',
    'js/app-ui.js?v=2.0.45',
    'js/app-events.js?v=2.0.45',
    'js/app-init.js?v=2.0.45',
    'js/app-runtime.js?v=2.0.45',
    'js/app-entry.js?v=2.0.45',
    'js/items-view.js?v=2.0.45',
    'js/items-actions.js?v=2.0.45',
    'js/tabs-view.js?v=2.0.45',
    'js/helpers.js?v=2.0.45',
    'manifest.php?v=2.0.45',
    'icon.php?size=192&theme=hafenblau&v=2.0.45',
    'icon.php?size=512&theme=hafenblau&v=2.0.45',
    'icons/icon.svg',
    'icons/icon-192.png',
    'icons/icon-512.png',
