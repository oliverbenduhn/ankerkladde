...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/main.js?v=4.1.11',
    'js/api.js?v=4.1.11',
    'js/state.js?v=4.1.11',
    'js/ui.js?v=4.1.11',
    'js/utils.js?v=4.1.11',
    'js/shared.js?v=4.1.11',
    'js/theme.js?v=4.1.11',
    'js/navigation.js?v=4.1.11',
    'js/router.js?v=4.1.11',
    'js/items.js?v=4.1.11',
    'js/scanner.js?v=4.1.11',
    'js/editor.js?v=4.1.11',
    'js/swipe.js?v=4.1.11',
    'js/reorder.js?v=4.1.11',
    'js/app-ui.js?v=4.1.11',
    'js/app-events.js?v=4.1.11',
    'js/app-init.js?v=4.1.11',
    'js/app-runtime.js?v=4.1.11',
    'js/app-entry.js?v=4.1.11',
    'js/items-view.js?v=4.1.11',
    'js/items-actions.js?v=4.1.11',
    'js/tabs-view.js?v=4.1.11',
    'js/helpers.js?v=4.1.11',
    'vendor/zxing/browser-0.1.5.js?v=4.1.11',
    'manifest.php?v=4.1.11',
