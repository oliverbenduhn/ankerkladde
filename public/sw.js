...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=2.0.55',
    'js/utils.js?v=2.0.55',
    'js/shared.js?v=2.0.55',
    'js/theme.js?v=2.0.55',
    'js/navigation.js?v=2.0.55',
    'js/router.js?v=2.0.55',
    'js/items.js?v=2.0.55',
    'js/scanner.js?v=2.0.55',
    'js/editor.js?v=2.0.55',
    'js/swipe.js?v=2.0.55',
    'js/reorder.js?v=2.0.55',
    'js/app-ui.js?v=2.0.55',
    'js/app-events.js?v=2.0.55',
    'js/app-init.js?v=2.0.55',
    'js/app-runtime.js?v=2.0.55',
    'js/app-entry.js?v=2.0.55',
    'js/items-view.js?v=2.0.55',
    'js/items-actions.js?v=2.0.55',
    'js/tabs-view.js?v=2.0.55',
    'js/helpers.js?v=2.0.55',
    'vendor/zxing/browser-0.1.5.js?v=2.0.55',
    'manifest.php?v=2.0.55',
