...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=4.1.0',
    'js/utils.js?v=4.1.0',
    'js/shared.js?v=4.1.0',
    'js/theme.js?v=4.1.0',
    'js/navigation.js?v=4.1.0',
    'js/router.js?v=4.1.0',
    'js/items.js?v=4.1.0',
    'js/scanner.js?v=4.1.0',
    'js/editor.js?v=4.1.0',
    'js/swipe.js?v=4.1.0',
    'js/reorder.js?v=4.1.0',
    'js/app-ui.js?v=4.1.0',
    'js/app-events.js?v=4.1.0',
    'js/app-init.js?v=4.1.0',
    'js/app-runtime.js?v=4.1.0',
    'js/app-entry.js?v=4.1.0',
    'js/items-view.js?v=4.1.0',
    'js/items-actions.js?v=4.1.0',
    'js/tabs-view.js?v=4.1.0',
    'js/helpers.js?v=4.1.0',
    'vendor/zxing/browser-0.1.5.js?v=4.1.0',
    'manifest.php?v=4.1.0',
