...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=2.0.54',
    'js/utils.js?v=2.0.54',
    'js/shared.js?v=2.0.54',
    'js/theme.js?v=2.0.54',
    'js/navigation.js?v=2.0.54',
    'js/router.js?v=2.0.54',
    'js/items.js?v=2.0.54',
    'js/scanner.js?v=2.0.54',
    'js/editor.js?v=2.0.54',
    'js/swipe.js?v=2.0.54',
    'js/reorder.js?v=2.0.54',
    'js/app-ui.js?v=2.0.54',
    'js/app-events.js?v=2.0.54',
    'js/app-init.js?v=2.0.54',
    'js/app-runtime.js?v=2.0.54',
    'js/app-entry.js?v=2.0.54',
    'js/items-view.js?v=2.0.54',
    'js/items-actions.js?v=2.0.54',
    'js/tabs-view.js?v=2.0.54',
    'js/helpers.js?v=2.0.54',
    'vendor/zxing/browser-0.1.5.js?v=2.0.54',
    'manifest.php?v=2.0.54',
    'icon.php?size=192&theme=hafenblau&v=2.0.54',
    'icon.php?size=512&theme=hafenblau&v=2.0.54',
    'icons/icon.svg',
    'icons/icon-192.png',
    'icons/icon-512.png',
