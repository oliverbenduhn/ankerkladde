...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=2.0.46',
    'js/utils.js?v=2.0.46',
    'js/shared.js?v=2.0.46',
    'js/theme.js?v=2.0.46',
    'js/navigation.js?v=2.0.46',
    'js/router.js?v=2.0.46',
    'js/items.js?v=2.0.46',
    'js/scanner.js?v=2.0.46',
    'js/editor.js?v=2.0.46',
    'js/swipe.js?v=2.0.46',
    'js/reorder.js?v=2.0.46',
    'js/app-ui.js?v=2.0.46',
    'js/app-events.js?v=2.0.46',
    'js/app-init.js?v=2.0.46',
    'js/app-runtime.js?v=2.0.46',
    'js/app-entry.js?v=2.0.46',
    'js/items-view.js?v=2.0.46',
    'js/items-actions.js?v=2.0.46',
    'js/tabs-view.js?v=2.0.46',
    'js/helpers.js?v=2.0.46',
    'manifest.php?v=2.0.46',
    'icon.php?size=192&theme=hafenblau&v=2.0.46',
    'icon.php?size=512&theme=hafenblau&v=2.0.46',
    'icons/icon.svg',
    'icons/icon-192.png',
    'icons/icon-512.png',
