...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/main.js?v=2.0.13',
    'js/api.js?v=2.0.13',
    'js/state.js?v=2.0.13',
    'js/ui.js?v=2.0.13',
    'js/utils.js?v=2.0.13',
    'js/shared.js?v=2.0.13',
    'js/theme.js?v=2.0.13',
    'js/navigation.js?v=2.0.13',
    'js/router.js?v=2.0.13',
    'js/items.js?v=2.0.13',
    'manifest.php?v=2.0.13',
    'icon.php?size=192&theme=hafenblau&v=2.0.13',
    'icon.php?size=512&theme=hafenblau&v=2.0.13',
    'icons/icon.svg',
    'icons/icon-192.png',
    'icons/icon-512.png',
