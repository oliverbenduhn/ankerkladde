...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=4.0.8',
    'js/utils.js?v=4.0.8',
    'js/shared.js?v=4.0.8',
    'js/theme.js?v=4.0.8',
    'js/navigation.js?v=4.0.8',
    'js/router.js?v=4.0.8',
    'js/items.js?v=4.0.8',
    'js/scanner.js?v=4.0.8',
    'js/editor.js?v=4.0.8',
    'js/swipe.js?v=4.0.8',
    'js/reorder.js?v=4.0.8',
    'js/app-ui.js?v=4.0.8',
    'js/app-events.js?v=4.0.8',
    'js/app-init.js?v=4.0.8',
    'js/app-runtime.js?v=4.0.8',
    'js/app-entry.js?v=4.0.8',
    'js/items-view.js?v=4.0.8',
    'js/items-actions.js?v=4.0.8',
    'js/tabs-view.js?v=4.0.8',
    'js/helpers.js?v=4.0.8',
    'vendor/zxing/browser-0.1.5.js?v=4.0.8',
    'manifest.php?v=4.0.8',
