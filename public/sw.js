...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=2.0.43',
    'js/utils.js?v=2.0.43',
    'js/shared.js?v=2.0.43',
    'js/theme.js?v=2.0.43',
    'js/navigation.js?v=2.0.43',
    'js/router.js?v=2.0.43',
    'js/items.js?v=2.0.43',
    'js/scanner.js?v=2.0.43',
    'js/editor.js?v=2.0.43',
    'js/swipe.js?v=2.0.43',
    'js/reorder.js?v=2.0.43',
    'js/app-ui.js?v=2.0.43',
    'js/app-events.js?v=2.0.43',
    'js/app-init.js?v=2.0.43',
    'js/items-view.js?v=2.0.43',
    'js/items-actions.js?v=2.0.43',
    'js/tabs-view.js?v=2.0.43',
    'js/helpers.js?v=2.0.43',
    'manifest.php?v=2.0.43',
    'icon.php?size=192&theme=hafenblau&v=2.0.43',
    'icon.php?size=512&theme=hafenblau&v=2.0.43',
    'icons/icon.svg',
    'icons/icon-192.png',
    'icons/icon-512.png',
