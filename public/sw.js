...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=3.0.4',
    'js/utils.js?v=3.0.4',
    'js/shared.js?v=3.0.4',
    'js/theme.js?v=3.0.4',
    'js/navigation.js?v=3.0.4',
    'js/router.js?v=3.0.4',
    'js/items.js?v=3.0.4',
    'js/scanner.js?v=3.0.4',
    'js/editor.js?v=3.0.4',
    'js/swipe.js?v=3.0.4',
    'js/reorder.js?v=3.0.4',
    'js/app-ui.js?v=3.0.4',
    'js/app-events.js?v=3.0.4',
    'js/app-init.js?v=3.0.4',
    'js/app-runtime.js?v=3.0.4',
    'js/app-entry.js?v=3.0.4',
    'js/items-view.js?v=3.0.4',
    'js/items-actions.js?v=3.0.4',
    'js/tabs-view.js?v=3.0.4',
    'js/helpers.js?v=3.0.4',
    'vendor/zxing/browser-0.1.5.js?v=3.0.4',
    'manifest.php?v=3.0.4',
