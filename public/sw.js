...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/ui.js?v=4.0.7',
    'js/utils.js?v=4.0.7',
    'js/shared.js?v=4.0.7',
    'js/theme.js?v=4.0.7',
    'js/navigation.js?v=4.0.7',
    'js/router.js?v=4.0.7',
    'js/items.js?v=4.0.7',
    'js/scanner.js?v=4.0.7',
    'js/editor.js?v=4.0.7',
    'js/swipe.js?v=4.0.7',
    'js/reorder.js?v=4.0.7',
    'js/app-ui.js?v=4.0.7',
    'js/app-events.js?v=4.0.7',
    'js/app-init.js?v=4.0.7',
    'js/app-runtime.js?v=4.0.7',
    'js/app-entry.js?v=4.0.7',
    'js/items-view.js?v=4.0.7',
    'js/items-actions.js?v=4.0.7',
    'js/tabs-view.js?v=4.0.7',
    'js/helpers.js?v=4.0.7',
    'vendor/zxing/browser-0.1.5.js?v=4.0.7',
    'manifest.php?v=4.0.7',
