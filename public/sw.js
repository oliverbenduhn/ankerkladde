...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/main.js?v=2.0.10',
    'js/api.js?v=2.0.10',
    'js/state.js?v=2.0.10',
    'js/ui.js?v=2.0.10',
    'js/utils.js?v=2.0.10',
    'js/shared.js?v=2.0.10',
    'js/theme.js?v=2.0.10',
    'js/navigation.js?v=2.0.10',
    'js/router.js?v=2.0.10',
    'manifest.php?v=2.0.10',
    'icon.php?size=192&theme=hafenblau&v=2.0.10',
    'icon.php?size=512&theme=hafenblau&v=2.0.10',
    'icons/icon.svg',
    'icons/icon-192.png',
    'icons/icon-512.png',
