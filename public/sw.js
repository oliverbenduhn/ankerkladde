...
const APP_SHELL_ASSET_URLS = [
    ...
    'js/main.js?v=4.1.10',
    'js/api.js?v=4.1.10',
    'js/state.js?v=4.1.10',
    'js/ui.js?v=4.1.10',
    'js/utils.js?v=4.1.10',
    'js/shared.js?v=4.1.10',
    'js/theme.js?v=4.1.10',
    'js/navigation.js?v=4.1.10',
    'js/router.js?v=4.1.10',
    'js/items.js?v=4.1.10',
    'js/scanner.js?v=4.1.10',
    'js/editor.js?v=4.1.10',
    'js/swipe.js?v=4.1.10',
    'js/reorder.js?v=4.1.10',
    'js/app-ui.js?v=4.1.10',
    'js/app-events.js?v=4.1.10',
    'js/app-init.js?v=4.1.10',
    'js/app-runtime.js?v=4.1.10',
    'js/app-entry.js?v=4.1.10',
    'js/items-view.js?v=4.1.10',
    'js/items-actions.js?v=4.1.10',
    'js/tabs-view.js?v=4.1.10',
    'js/helpers.js?v=4.1.10',
    'vendor/zxing/browser-0.1.5.js?v=4.1.10',
    'manifest.php?v=4.1.10',
