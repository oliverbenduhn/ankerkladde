...
import { appUrl } from './api.js?v=5.1.23';
import { appEl, magicBtns, magicBar, magicInput, magicSubmit, magicClose, magicVoiceBtn } from './ui.js?v=5.1.23';
import { state, csrfToken } from './state.js?v=5.1.23';
