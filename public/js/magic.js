...
import { appUrl } from './api.js?v=5.3.9';
import { appEl, magicBtns, magicBar, magicInput, magicSubmit, magicClose, magicVoiceBtn } from './ui.js?v=5.3.9';
import { state, csrfToken } from './state.js?v=5.3.9';
