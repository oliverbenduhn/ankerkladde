...
import { getAvailableLayouts, getCurrentCategory, getCurrentType, getTypeConfig, isAttachmentCategory, state } from './state.js?v=5.3.9';
import {
    cameraBtn,
    categoryTitleEl,
    diskFreeEl,
...
import { syncAutoHeight } from './utils.js?v=5.3.9';
