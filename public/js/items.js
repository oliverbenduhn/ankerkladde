import { api, normalizeItem, persistPreferences } from './api.js?v=5.3.12';
import { LOCAL_PREF_KEYS, state } from './state.js?v=5.3.12';
import { appEl, searchBar, searchBtn, searchInput } from './ui.js?v=5.3.12';
