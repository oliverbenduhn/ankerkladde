...
import { getCurrentType, state } from './state.js?v=5.3.12';
import { clearDoneBtn, listEl, progressEl, svgIcon } from './ui.js?v=5.3.12';
import { normalizeBarcodeValue, sanitizeItemField, syncAutoHeight } from './utils.js?v=5.3.12';
import { createLightboxController } from './lightbox.js?v=5.3.12';
import { createItemMenuController } from './item-menu.js?v=5.3.12';

let sketchEditorModulePromise = null;
async function loadSketchEditor() {
    if (!sketchEditorModulePromise) {
        sketchEditorModulePromise = import('./sketch-editor.js?v=5.3.12');
    }
