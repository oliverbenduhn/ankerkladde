...
export const itemSubmitBtn = document.getElementById('itemSubmitBtn');
export const manualAddBtn = document.getElementById('manualAddBtn');
export const quickAddFeedback = document.getElementById('quickAddFeedback');
export const quickAddFeedbackText = document.getElementById('quickAddFeedbackText');
export const quickAddAiBtn = document.getElementById('quickAddAiBtn');
...
export const journalBtn = document.getElementById('journalBtn');
...
export const layoutToggleBtn = document.getElementById('layoutToggleBtn');
export const LAYOUT_ICONS = { list: 'menu', grid: 'layout-grid', kanban: 'layout-kanban' };
export const categoryTitleEl = document.getElementById('categoryTitle');
...
export const itemEditorEl = document.getElementById('itemEditor');
export const itemEditorBack = document.getElementById('itemEditorBack');
export const itemCreateBtn = document.getElementById('itemCreateBtn');
export const itemSaveBtn = document.getElementById('itemSaveBtn');
export const itemEditorBody = document.getElementById('itemEditorBody');
export const itemTitleInput = document.getElementById('itemTitleInput');
export const itemCategorySection = document.getElementById('itemCategorySection');
export const itemCategoryInput = document.getElementById('itemCategoryInput');
export const itemQuantitySection = document.getElementById('itemQuantitySection');
export const itemQuantityInput = document.getElementById('itemQuantityInput');
export const itemBarcodeInput = document.getElementById('itemBarcodeInput');
export const itemDueDateSection = document.getElementById('itemDueDateSection');
export const itemDateInput = document.getElementById('itemDateInput');
export const itemTimeInput = document.getElementById('itemTimeInput');
export const itemPriorityInput = document.getElementById('itemPriorityInput');
export const itemNoteSection = document.getElementById('itemNoteSection');
export const itemNoteInput = document.getElementById('itemNoteInput');
export const itemStatusSelector = document.getElementById('itemStatusSelector');
export const itemStatusSection = document.getElementById('itemStatusSection');
...
export const settingsDialogEl = document.getElementById('settingsDialog');
export const settingsDialogCloseEl = document.getElementById('settingsDialogClose');
export const settingsDialogContentEl = document.getElementById('settingsDialogContent');
export const journalViewEl = document.getElementById('journalView');
export const journalBackBtn = document.getElementById('journalBackBtn');
export const journalDatePickerBtn = document.getElementById('journalDatePickerBtn');
...
export const journalAnytimeList = document.getElementById('journalAnytimeList');
export const journalScheduledList = document.getElementById('journalScheduledList');
export const journalAgendaBody = document.getElementById('journalAgendaBody');
export const journalAgendaCollapseBtn = document.getElementById('journalAgendaCollapseBtn');
export const agendaAddBtn = document.getElementById('agendaAddBtn');
export const journalFormatBtn = document.getElementById('journalFormatBtn');
...
export const journalSketchPreviewBtn = document.getElementById('journalSketchPreviewBtn');
