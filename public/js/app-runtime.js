...
import { createRouter } from './router.js?v=5.1.12';
...
import { createTodayViewController } from './today-view.js?v=5.1.12';
import { createJournalController } from './journal.js?v=5.1.12';
