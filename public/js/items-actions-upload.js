...
import { api, apiUpload } from './api.js?v=5.1.27';
import { getCurrentCategory, isAttachmentCategory } from './state.js?v=5.1.27';
import { fileInput, itemInput, urlImportInput } from './ui.js?v=5.1.27';
