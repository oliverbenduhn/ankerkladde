import { saveLocalPrefs, state, scannerState, themeMediaQuery, isAttachmentCategory, normalizePreferences, getCurrentType } from './state.js?v=4.2.94';
import { normalizeSettingsTab } from './api.js?v=4.2.94';
import {
    appEl,
    cameraBtn,
    cameraInput,
