import { saveLocalPrefs, state, scannerState, themeMediaQuery, isAttachmentCategory, normalizePreferences, getCurrentType } from './state.js?v=4.2.98';
import { normalizeSettingsTab } from './api.js?v=4.2.98';
import {
    appEl,
    cameraBtn,
    cameraInput,
