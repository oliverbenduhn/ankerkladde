import { normalizeSettingsTab, settingsUrl } from './api.js?v=4.2.97';
import { state } from './state.js?v=4.2.97';
import { appEl, searchInput, settingsBtns, settingsEmbedEl, settingsFrameEl } from './ui.js?v=4.2.97';
