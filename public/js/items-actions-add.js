...
import { appUrl, api, fetchLinkMetadata } from './api.js?v=5.1.28';
import { getCurrentCategory, isAttachmentCategory, state } from './state.js?v=5.1.28';
import {
    itemInput,
...
import { enqueueAction } from './offline-queue.js?v=5.1.28';
