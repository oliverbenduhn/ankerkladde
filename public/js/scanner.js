...
import { BARCODE_FORMATS, isBarcodeCategory, isIosWebKit, isScannerSupported, scannerState, state } from './state.js?v=5.1.29';
import { itemForm, itemInput, quantityInput, scannerManualForm, scannerManualInput, scannerOverlay, scannerStatus, scannerSubtitle, scannerVideo } from './ui.js?v=5.1.29';
import { normalizeBarcodeValue, sanitizeItemField, sanitizeItemPayload, syncAutoHeight } from './utils.js?v=5.1.29';
