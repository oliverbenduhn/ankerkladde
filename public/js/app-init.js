...
import { applyViewState } from './router.js?v=5.1.24';
import { appEl, updateBannerEl, updateViewportHeight } from './ui.js?v=5.1.24';
import { loadAgenda, updateAppBadge } from './today-view.js?v=5.1.24';
