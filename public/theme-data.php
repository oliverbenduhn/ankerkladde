    ...
    'light' => [
        ...
        'grauton' => [
            ...
            'tokens' => [
                ...
                '--error'             => '#c0392b',
                '--brand-mark-surface' => 'rgba(250, 250, 250, 0.94)',
                '--brand-mark-border' => 'rgba(42, 42, 42, 0.15)',
                '--brand-mark-shadow' => '0 12px 24px rgba(42, 42, 42, 0.1)',
                '--brand-mark-filter' => 'saturate(1) contrast(1)',
                '--tab-icon-chip' => 'rgba(42, 42, 42, 0.1)',
                '--tab-icon-chip-active' => 'rgba(42, 42, 42, 0.2)',
                '--tab-icon-filter' => 'saturate(0.5) brightness(0.9)',
                '--tab-icon-filter-active' => 'saturate(0.6) brightness(0.8)',
                '--toast-success-bg' => 'rgba(76, 175, 80, 0.1)',
                '--toast-success-text' => '#2a5a1f',
                '--toast-error-bg' => 'rgba(192, 57, 43, 0.1)',
                '--toast-error-text' => '#8b2c1b',
            ],
        ],
