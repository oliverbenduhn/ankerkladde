    ...
    'light' => [
        ...
        'lavendelsegel' => [
            ...
            'tokens' => [
                ...
                '--button-active-bg' => '#6030a8',
                '--button-active-text' => '#ffffff',
                '--toast-success-bg' => 'rgba(96, 48, 168, 0.12)',
                '--toast-success-text' => '#2a1254',
                '--toast-error-bg' => 'rgba(192, 57, 43, 0.12)',
                '--toast-error-text' => '#6e1a10',
            ],
        ],
    ...
    'dark' => [
        ...
        'abyssus' => [
            ...
            'tokens' => [
                ...
                '--button-active-bg' => '#7840d4',
                '--button-active-text' => '#ffffff',
                '--toast-success-bg' => 'rgba(120, 64, 212, 0.15)',
                '--toast-success-text' => '#b0f0a0',
                '--toast-error-bg' => 'rgba(224, 80, 80, 0.15)',
                '--toast-error-text' => '#ff90d0',
            ],
        ],
        'monochrom-dark' => [
