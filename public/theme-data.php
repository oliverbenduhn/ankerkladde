    ...
    'light' => [
        ...
        'regenbogen' => [
            ...
            'tokens' => [
                ...
                '--border'            => '#d8c4ec',
                '--text-primary'      => '#1a1030',
                '--text-primary-dark' => '#0e081e',
                '--text-secondary'    => '#6a3ea8',
                '--text-muted'        => '#9a80c0',
                '--accent'            => '#6830b8',
                '--done-bg'           => '#e8f0d8',
                '--error'             => '#c0392b',
                '--brand-mark-surface' => 'linear-gradient(135deg, rgba(232, 210, 255, 0.7), rgba(210, 230, 255, 0.7), rgba(210, 255, 230, 0.7), rgba(255, 230, 210, 0.7))',
                '--brand-mark-border' => 'rgba(104, 48, 184, 0.2)',
                '--brand-mark-shadow' => '0 12px 24px rgba(104, 48, 184, 0.14)',
                '--brand-mark-filter' => 'saturate(1) contrast(1)',
                '--tab-icon-chip' => 'rgba(104, 48, 184, 0.12)',
                '--tab-icon-chip-active' => 'rgba(104, 48, 184, 0.25)',
                '--tab-icon-filter' => 'saturate(1.05) hue-rotate(260deg) brightness(1.02)',
                '--tab-icon-filter-active' => 'saturate(1.18) hue-rotate(265deg) brightness(0.97)',
                '--button-active-bg' => '#6830b8',
                '--button-active-text' => '#ffffff',
                '--toast-success-bg' => 'rgba(76, 175, 80, 0.12)',
