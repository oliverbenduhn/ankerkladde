...
function normalizeExtendedUserPreferences(array $preferences): array
{
    ...
    $normalized = [
        ...
        'ai_provider' => (string) ($base['ai_provider'] ?? 'gemini'),
        'openai_compatible_api_key' => (string) ($base['openai_compatible_api_key'] ?? ''),
        'openai_compatible_model' => (string) ($base['openai_compatible_model'] ?? 'gpt-4o-mini'),
        'openai_compatible_base_url' => (string) ($base['openai_compatible_base_url'] ?? 'https://api.openai.com/v1'),
